/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c9e8cffdc43bd7a2e857e3dc8cf39215)
// Runtime types generated with workerd@1.20260302.0 2024-12-18 nodejs_compat
...
declare class File extends Blob {
    ...
    get name(): string;
    /**
     * The **`lastModified`** read-only property of the File interface provides the last modified date of the file as the number of milliseconds since the Unix epoch (January 1, 1970 at 4pm).
     *
